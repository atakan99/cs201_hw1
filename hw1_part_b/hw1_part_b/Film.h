...
public:
	...
	Actor& setActor(int i);
	unsigned int getnoOfActors();
	unsigned int& setnoOfActors();
	unsigned int getActorSize();
	unsigned int& setActorSize();
	bool addFilmActor(Actor &a);
	bool removeFilmActors(const string fTitle, const string fDirector);
